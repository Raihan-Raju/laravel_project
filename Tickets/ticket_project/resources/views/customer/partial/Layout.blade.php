 ...
 <head>
     ...
     <title>{{ Auth::guard('customer')->user()->name }}</title>
                 ...
                 <div class="sidebar-content">
                     <ul class="nav nav-secondary">
                         ...
                         <li class="nav-section">
                             ...
                             <h4 class="text-section">Ticket</h4>
                         </li>
                         ...
                         <li class="nav-item">
                             <a href="{{ route('customer.ticket.create') }}">
                                 <i class="fas fa-exchange-alt"></i>
                                 <span class="sub-item">Ticket Create</span>
                             </a>
                         </li>

                         {{-- <li class="nav-item">
                             <a data-bs-toggle="collapse" href="#trip_voucher">
                                 <i class="fas fa-truck"></i>
                                 <p>Trip Voucher</p>
                                 <span class="caret"></span>
                             </a>
                             <div class="collapse" id="trip_voucher">
                                             ...
                                             <div class="notif-center">
                                                 <a href="#">
                                                     ...
                                                     <div class="notif-content">
                                                         <span
                                                             class="subject">{{ Auth::guard('customer')->user()->name }}</span>
