        ...
        <header class="navbar navbar-expand-md d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('static/hero.png') }}" width="110" height="32" alt="Salcabil-Resrora-Management"
                            class="navbar-brand-image">
                            
                    </a>
                </h1>
                <h5>Salcabil-Resrora-Management</h5>
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="https://techraihanraju.online/" target="_blank"
                                        class="link-secondary" rel="noopener">Raihan Raju</a></li>
                        ...
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    ...
                                    <a href="." class="link-secondary">Raihan Raju</a>.
                                    All rights reserved.
                                </li>
